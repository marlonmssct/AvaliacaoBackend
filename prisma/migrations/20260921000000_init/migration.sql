...
-- AddForeignKey
ALTER TABLE "tickets" ADD CONSTRAINT "tickets_ticket_batch_id_fkey" FOREIGN KEY ("ticket_batch_id") REFERENCES "ticket_batches"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "check_ins" ADD CONSTRAINT "check_ins_checked_in_by_user_id_fkey" FOREIGN KEY ("checked_in_by_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
